...
all the functions in your program. When you develop your own lab9 
modules, make sure any other code in your lab9.py file is under the 
...
if __name__ == "__main__":
    ...
    doctest.testmod(Check_2, verbose=True)
